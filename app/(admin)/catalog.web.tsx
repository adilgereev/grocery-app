...
import { ActivityIndicator, SectionList, Image, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
import { ProductWithCategory } from '@/types';

export default function CatalogScreenWeb() {
...
const styles = StyleSheet.create({
  ...
  list: { padding: Spacing.m, maxWidth: 800, marginHorizontal: 'auto', width: '100%' },
  card: {
