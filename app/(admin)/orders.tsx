        ...
        <View style={styles.card}>
          ...
          <View style={styles.customerInfo}>
            <TouchableOpacity
              ...
              onPress={() => callCustomer(profile?.phone)}
            >
              <Ionicons
                name="person-circle"
                size={24}
          ...
          <View style={styles.addressBox}>
            ...
            <Text style={styles.addressText} numberOfLines={2}>
              {cleanAddress(item.delivery_address)}
            </Text>
          </View>
          ...
          >
            <Text style={styles.expandButtonText}>
              {expandedOrders.includes(item.id)
                ...
                : `Показать товары (${item.items?.length || 0})`}
            </Text>
            <Ionicons
              name={
                expandedOrders.includes(item.id) ? "chevron-up" : "chevron-down"
              }
              size={16}
