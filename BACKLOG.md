...
- [x] Добавить кнопку очистки всей корзины
- [x] Добавить вибро-отклик (Haptic Feedback) при добавлении товара в корзину
...
- [ ] **Не очищается код оператора на странице авторизации.**
