...
### 🔄 Админ-панель: Синхронизация

- [ ] Синхронизация функционала бизнес админки и мобильной админки — унификация
      интерфейсов управления и паритет функций между веб и мобильной версиями.
