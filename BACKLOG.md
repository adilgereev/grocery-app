...
- [x] Аудит и доработка визуала горизонтального скролла популярных товаров:
...
- [ ] `app/privacy-policy.tsx` (230 строк) — вынести секции в отдельные компоненты
- [ ] `app/public-offer.tsx` (383 строки) — вынести секции в отдельные компоненты
- [ ] `components/auth/PhoneStep.tsx` (203 строки) — вынести блок согласия в отдельный компонент
