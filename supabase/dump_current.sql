...
ALTER FUNCTION "public"."select_delivery_address"("p_user_id" "uuid", "p_address_id" "uuid") OWNER TO "postgres";
...
ALTER VIEW "public"."categories_with_hierarchy" OWNER TO "postgres";
...
CREATE POLICY "Users can delete their own order items." ON "public"."order_items" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."orders"
...
CREATE POLICY "Users can modify their own addresses" ON "public"."addresses" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "stories_admin_all" ON "public"."stories" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
...
CREATE POLICY "stories_select_active" ON "public"."stories" FOR SELECT USING ((("is_active" = true) AND (("expires_at" IS NULL) OR ("expires_at" > "now"()))));
